...
<hr>
Zum Berliner Attentat gibt es im ersten Jahr über `r conservative(nrow(subset(dat,attack=="berlin" & full_days_since_attack %in% 0:365  & count>0)),2)`  Suchergebnisse—fast jeden zweiten Tag findet sich in jeder Zeitung eine Erwähnung. Bei Bild an zwei von drei Tagen:<br/>
...
```
Zwischenfazit: Es scheint als wird zu anderen Attentaten viel, häufig und lange geschrieben. Das ist gut und das sollten wir für #Hanau auch tun. 
